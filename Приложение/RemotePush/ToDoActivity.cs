...
namespace RemotePush
{
    ...
    public class ToDoActivity : Activity
    {
        ...
        private IMobileServiceTable<UserItem> userTable;
#endif
        ...
        const string applicationURL = @"https://remotepush.azurewebsites.net";
        ...
        [Java.Interop.Export()]
        public async void AskServer(View view)
        {
            try
            {
                var r = await client.InvokeApiAsync<string>("messaging", HttpMethod.Post, null);
                //CreateAndShowDialog(r, "Info");
                //var t = await client.InvokeApiAsync("api/messaging");
            }
            catch (Exception e)
            {
                CreateAndShowDialog(e, "Error");
        ...
        [Java.Interop.Export()]
        public async void AddUser(View view)
        {
            if (client == null || string.IsNullOrWhiteSpace(textNewToDo.Text))
            {
                return;
